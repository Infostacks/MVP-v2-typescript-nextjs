  ...
  return (
    <div className="flex flex-col items-center h-auto my-18 max-w-screen-lg gap-36 w-full">
      <div className="w-full flex items-center flex-col justify-evenly h-screen px-14">
        <h1 className="lg:text-7xl xl:text-7xl md:text-3xl text-2xl font-bold text-center text-slate-400 pt-32 lg:max-w-4xl sm:max-w-sm">
          Get a Remote Developer Position with Silicon Valley Companies
        </h1>
        <p className="text-2xl max-w-md text-center text-gray-400">
