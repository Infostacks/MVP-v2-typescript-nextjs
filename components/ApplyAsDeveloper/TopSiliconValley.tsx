...
const TopSiliconValleyCard = () => {
  return (
    <div className="drop-shadow-md shadow-lg w-2/3 md:w-3/4 xl:w-full lg:w-5/6 px-10 border-primary shadow-primary flex flex-col border-2 max-w-screen-lg items-center justify-evenly h-96 rounded-3xl">
