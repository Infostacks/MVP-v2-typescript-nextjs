...
const SliderIcons = () => {
  return (
    <div className="flex flex-col items-center gap-20">
      ...
      <div className="drop-shadow-md shadow-lg flex-wrap shadow-cyan-200 flex flex-row items-center justify-around bg-gray-900 rounded-full md:max-w-xl xl:max-w-5xl lg:max-w-4xl max-w-xs h-full p-10">
        <Swiper
          spaceBetween={30}
          slidesPerView={7}
          loop={true}
