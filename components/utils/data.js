...
const hiringData = [
  {
    icon: <VscSettingsGear className=" w-16 h-16 text-txtColor" />,
    heading: "Loom Video",
  ...
  {
    icon: <TbHeartRateMonitor className=" w-16 h-16 text-txtColor" />,
    heading: "Online Test",
    desc: "If the candidate passes the 1st step, they then have to take 2 quizzes personalized to their skills.",
  },
  {
    icon: <BiMessageAlt className=" w-16 h-16 text-txtColor" />,
  ...
  {
    icon: <HiOutlineDesktopComputer className=" w-16 h-16 text-txtColor" />,
  ...
  {
    icon: <BsCalendar4Week className=" w-16 h-16 text-txtColor" />,
    heading: "Test Phase",
